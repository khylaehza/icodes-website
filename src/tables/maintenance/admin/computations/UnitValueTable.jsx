...
import { EditUnitValue } from '../../../../modals';
const UnitValueTable = ({ all }) => {
			...
			return (
				...
				>
					<React.Fragment>
						...
						<CusTD component={data.ValueID} />
						<CusTitle component={'Tower'} />
						<CusTD component={data.Tower} />
						<CusTitle component={'Year'} />
						<CusTD component={data.Years} />
						<CusTitle component={'Increase %'} />
						<CusTD component={`${data.Increase}%`} />
