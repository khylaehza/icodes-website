					...
					if (Object.values(element).length != 0) {
						...
						k.map((x) => {
							if (x.name === e) {
								...
								type[`Units.${x.floor}.${x.no}.typeName`] =
									'------';
								image[`Units.${x.floor}.${x.no}.typeImage`] =
									'------';
								size[`Units.${x.floor}.${x.no}.typeSize`] =
									'------';
								status[`Units.${x.floor}.${x.no}.status`] =
									'Pending Details';
								status[`Units.${x.floor}.${x.no}.category.2`] =
									'';
